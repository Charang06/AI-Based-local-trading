...
class ProductDetailScreen extends StatelessWidget {
  ...
  Future<void> _buyNow(BuildContext context) async {
    ...
    // Seller should not buy their own item
    if (user.uid == product.sellerId) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("You are the seller of this product.")),
      );
      return;
    }
              ...
              children: [
                ...
                if (!isOwner) ...[
                  ...
                  _actionBtn(
                    ...
                    onTap: isSold ? () {} : () => _buyNow(context),
                  ),
                ],

                // ✅ Seller view: show Manage Offers + Mark Sold
                if (isOwner) ...[
                  _actionBtn(
                    text: "Manage Offers",
                    color: const Color(0xFF2A7BF4),
                  ...
                  _actionBtn(
                    ...
                    onTap: isSold ? () {} : () => _markAsSold(context),
                  ),
                ],
              ],
            ),
