...
class _MyOffersScreenState extends State<MyOffersScreen> {
  ...
  Future<void> _speakOffersGuide(AppLang lang) async {
    ...
    if (lang == AppLang.si) {
      text =
          "මෙය මගේ යෝජනා තිරයයි. ඉහළ ටැබ් වලින් පැවතුණු, පිළිගත්, ප්‍රතික්ෂේප, හෝ සියල්ල තෝරන්න. "
          "ඔබ යවපු යෝජනා මෙහි පෙන්වයි. කාඩ් එකක් ඔබා යෝජනා චැට් එක විවෘත කරන්න. "
          "Read බොත්තමෙන් පෙන්වෙන යෝජනා අහන්න. Stop බොත්තමෙන් කථනය නවතන්න.";
    } else if (lang == AppLang.ta) {
      text =
          "இது என் சலுகைகள் திரை. மேலே உள்ள டாப்களில் நிலுவை, ஏற்றுக்கொண்டது, நிராகரிக்கப்பட்டது அல்லது அனைத்து தேர்வு செய்யவும். "
          "நீங்கள் அனுப்பிய சலுகைகள் இங்கே காட்டப்படும். ஒரு கார்டை தொட்ந்து சலுகை சாட் திறக்கவும். "
          "Read மூலம் காணப்படும் சலுகைகளை கேட்கலாம். Stop மூலம் பேசுவதை நிறுத்தலாம்.";
    } else {
      text =
          "This is the My Offers screen. Use the tabs to view Pending, Accepted, Rejected, or All. "
          "Your sent offers are shown here. Tap any offer card to open the chat. "
          "Use Read to hear the visible offers. Use Stop to cancel speaking.";
    }
